...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        '''
        This method will return the biggest rectangle based or area
        '''
    ...
    def square(cls, size=0):
        '''
        This method will return a new rectangle instance with the square

        Args:
            size (int): The size of the square

        Returns:
            Rectangle: A new rectangle instance with the square
        '''
