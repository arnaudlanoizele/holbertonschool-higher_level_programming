...
class Square:
    '''
    This class defines a square on its size
    Size must be an integer and positive

    Args:
        size (in): The size of the square, must be positive
    ...
    def __init__(self, size=0, position=0):
        ...
        if (
            ...
            raise isinstance("position must be a tuple of 2 positive integers")
    ...
    def area(self):
        ...
        This method will calculate the area of the square
            based on the formula : arrea = size^2
        '''
